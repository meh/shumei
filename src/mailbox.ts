...
export class Mailbox<T> implements Sender<T>, Receiver<T>, Wired {
	private buffer: Array<T>

	constructor(private channel: channel.Sender<T> & channel.Receiver<T> & Wired) {
		this.buffer = []
	}

	get wire() {
		return this.channel.wire
	}
